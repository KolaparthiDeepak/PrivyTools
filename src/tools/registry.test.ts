...
test('exact tool set', () => {
  expect(TOOLS.map((t) => t.id).sort()).toEqual(
    [
      'dev-base64', 'dev-case', 'dev-cron', 'dev-html-entities', 'dev-json-csv', 'dev-json-format', 'dev-json-ts', 'dev-json-yaml', 'dev-jwt', 'dev-query-json', 'dev-slug', 'dev-timestamp', 'dev-url',
